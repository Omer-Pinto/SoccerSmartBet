...
## See Also
- [Task 3.3: Fetch Lines Node](../../../../PRE_GAMBLING_OPTIMIZED_FLOW_TASKS.md#33-fetch-lines-from-winnercoil-node) - needs update to use The Odds API
- [Minimum Odds Threshold Config](../../../../PRE_GAMBLING_OPTIMIZED_FLOW_TASKS.md#12-configuration-management)
